...
\begin{definition}[Lie algebra 1-cochain]
  \label{def:LieOneCochain}
  %\uses{}
  \lean{VirasoroProject.LieOneCochain}
  \leanok
  A \term{1-cochain} of the Lie algebra $\gLie$ with coefficients in the vector
...
\begin{lemma}[Lie algebra 1-cochains form a vector space]
  \label{lem:LieOneCochain_vectorSpace}
  \uses{def:LieOneCochain}
  \lean{VirasoroProject.LieOneCochain.instModule}
  \leanok
...
\begin{definition}[Lie algebra 2-coboundary]
  ...
  \uses{lem:LieTwoCocycle_vectorSpace, lem:LieOneCochain_vectorSpace}
  \lean{VirasoroProject.LieOneCochain.bdryHom}
  \leanok
